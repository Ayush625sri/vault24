...
const Users = () => {
  ...
  return (
    <Layout title={"Dashboard - Users"}>
      <div className="flex flex-col xl:flex-row mb-8 pt-12 lg:pt-28 lg:pr-16">
        <AdminMenu />
        <div className="flex flex-col xl:w-full mt-6 xl:mx-10 lg:p-10 pt-4 h-fit  border-2 shadow-gray-400 shadow-lg text-white font-mono">
          ...
          <table className="mt-3 md:mt-8 ">
            ...
            {/* <hr className="my-4" />/ */}
            {users?.map((u, i) => (
              <tbody key={i} className="border-b-2 ">
                <tr>
                  <Td value={u.name} />
