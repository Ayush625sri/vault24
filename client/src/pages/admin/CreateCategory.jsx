  ...
  return (
    <Layout title={"Dashboard - Create Category"}>
      <div className="flex flex-col xl:flex-row mb-8 pt-12 lg:pt-28">
        <AdminMenu />
        <div className="flex flex-col xl:w-full mt-6 p-2 md:mx-10 md:p-10 pt-4 h-fit  border-2 shadow-gray-400 shadow-lg font-mono text-white ">
          ...
          <div className="mt-6 shadow-gray-400 shadow-md 	">
            <table className="text-2xl border-2  w-full ">
              ...
              <tbody className="lg:px-4  text-center ">
                {categories?.map((c) => (
                  <tr
