  ...
  return (
    <Layout title={"Page Not Found"}>
      <div className="h-[95vh] flex flex-col items-center justify-center text-3xl">
        ...
        <NavLink
          to="/"
          className="bg-gray-800 text-white hover:bg-white hover:text-gray-800 focus:scale-95 shadow-lg shadow-gray-400  px-4 py-3 border-gray-900 border-2 rounded-2xl text-xl"
        >
