  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="my-4 flex flex-col md:flex-row items-center justify-around gap-4 md:gap-8 text-xl">
        ...
        <button
          type="submit"
          className={`py-2 px-5 w-full shadow-gray-400 shadow-xl bg-green-800 text-white  rounded-md border-2 border-green-800 hover:bg-white hover:text-green-800 active:scale-95 `}
        >
          {message}
        </button>
      </div>
