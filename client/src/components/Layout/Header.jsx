    ...
    <nav className=" fixed z-10 bg-gray-900 text-white  w-full lg:flex lg:h-20 lg:items-center xl:px-10 lg:justify-between">
      <div className="flex justify-between items-center px-4 lg:px-1 py-3 ">
        <div className=" flex gap-1 pl-5 ">
          ...
          &nbsp;&nbsp;
          <NavLink className="font-semibold text-2xl tracking-tighter " to="/">
            VAULT24
          </NavLink>
        </div>

        <button id="menu" className="block lg:hidden " onClick={handleNav}>
          <svg
      ...
      >
        ...
        <div className="flex flex-col gap-3  px-4 py-2 text-2xl lg:flex-row lg:items-center lg:gap- xl:gap-10 ">
              ...
              >
                ...
                <li className="mt-6 lg:mt-0 mb-2 lg:mb-0 lg:text-3xl lg:px-4 lg:py-5 border-gray-800 border-2 hover:bg-white hover:text-gray-800">
                  <NavLink
                    to="/register"
                    className=" lg:text-3xl"
                    onClick={() => handleCloseNav("/register")}
                  >
                    Register
                  </NavLink>
                </li>
          ...
          {cart?.length > 0 ? (
            <Badge count={cart?.length} showZero className="mt-2 lg:mt-0">
              <NavLink
                to="/cart"
            ...
            <NavLink to="/cart" className="text-white mt-2 lg:mt-0 text-2xl">
              <span>Cart </span>
              {cart?.length > 0 && <BsCart4 className="text-white" />}
            </NavLink>
          )}
        </div>
      </div>
